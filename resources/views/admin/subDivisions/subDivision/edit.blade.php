                        ...
                        @if(config('default.dual_language'))
                            <div class="input-style-1">
                                ...
                                <input type="text" id="title_en" name="title_en" class="@error('title_en') is-invalid @enderror"
                                       placeholder="Title English" value="{{old('title_en',$subDivision->title_en)}}">
                                @error('title_en')
                                <div class="invalid-feedback">
                                    {{$message}}
                                </div>
                        ...
                        @if(config('default.dual_language'))
                            <div class="input-style-1">
                                ...
                                <textarea name="introduction_en" id="introduction_en" cols="30" rows="10"
                                          class="@error('introduction_en') is-invalid @enderror">{{old('introduction_en',$subDivision->introduction_en)}}</textarea>
