                            ...
                            <div class="select-position">
                                ...
                                <select id="designation_id" name="designation_id"
                                    ...
                                    @foreach($designations as $designation)
                                        <option
                                            value="{{$designation->id}}" {{old('designation_id',$designation->id )==$employee->designation_id ? 'selected':''}}>{{$designation->title}}</option>
                                    @endforeach
                                </select>
                            ...
                            <div class="select-position">
                                ...
                                <select id="department_id" name="department_id"
                                    ...
                                    @foreach($departments as $department)
                                        <option
                                            value="{{$department->id}}" {{old('department_id',$department->id )==$employee->department_id ? 'selected':''}}>{{$department->title}}</option>
                                    @endforeach
                                </select>
                                @error('department_id')
                                <div class="invalid-feedback">
