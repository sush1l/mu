            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="input-style-1">
                        ...
                        <textarea name="answer" id="answer" cols="30" rows="6" placeholder="Answer"></textarea>
                        @error('answer')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="question_en" name="question_en"
                               placeholder="Question English" value="{{old('question_en')}}">
                        @error('question_en')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-12">
                    <div class="input-style-1">
                        ...
                        <textarea name="answer_en" id="answer_en" cols="30" rows="6" placeholder="Answer English"></textarea>
                        @error('answer_en')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
