        ...
        <div class="row align-items-center">
            <div class="col-md-6">
                <div class="title mb-30">
                    <h2>बिल सार्बजनिकरण थप्नुहोस</h2>
                </div>
            </div>
            <!-- end col -->
            <div class="col-md-6">
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="budget_no" name="budget_no"
                               placeholder="बजेट नं." value="{{old('budget_no')}}">
                        @error('budget_no')
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="expense_head" name="expense_head"
                               placeholder="खर्च शिर्षक" value="{{old('expense_head')}}">
                        @error('expense_head')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="expense_head_en" name="expense_head_en"
                               placeholder="खर्च शिर्षक English" value="{{old('expense_head_en')}}">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="buying_process" name="buying_process" placeholder="खरिद प्रक्रिया" value="{{old('buying_process')}}">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="buying_process_en" name="buying_process_en" placeholder="खरिद प्रक्रिया English" value="{{old('buying_process_en')}}">
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="pan_no" name="pan_no" placeholder="पान न." value="{{old('pan_no')}}">
                        @error('pan_no')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="bill_date" name="bill_date" class="nepali-date" placeholder="बिल मिति">
                        @error('bill_date')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="receipt_date" name="receipt_date" class="nepali-date" placeholder="रसिद मिति">
                        @error('receipt_date')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="number" id="amount" name="amount" placeholder="रकम">
                        @error('amount')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                <div class="col-md-6">
                    <div class="input-style-1">
                        ...
                        <input type="text" id="remarks" name="remarks" placeholder="कैफियत">
                        @error('remarks')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                @if(config('default.dual_language'))
                    <div class="col-md-6">
                        <div class="input-style-1">
                            <label for="remarks_en">कैफियत</label>
                            <input type="text" id="remarks_en" name="remarks_en" placeholder="कैफियत English">
                            @error('remarks_en')
                            <p class="text-danger">{{$message}}</p>
                            @enderror
                        </div>
                ...
                <div class="col-md-12">
                    <div class="input-style-1">
                        ...
                        <textarea name="description" id="description" cols="30" rows="4" placeholder="विवरण"></textarea>
                        @error('description')
                        <p class="text-danger">{{$message}}</p>
                        @enderror
                    </div>
                ...
                @if(config('default.dual_language'))
                    <div class="col-md-12">
                        <div class="input-style-1">
                            ...
                            <textarea name="description_en" id="description_en" cols="30" rows="4" placeholder="विवरण English"></textarea>
