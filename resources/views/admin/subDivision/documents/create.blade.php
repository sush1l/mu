        ...
        <div class="row">
            <div class="col-lg-12">
                ...
                <div class="card-style mb-30">
                    <h6 class="mb-25">Sub Division Document</h6>
                    <form action="{{route('admin.subDivisionDocument.store')}}" method="POST"
                        ...
                        <div class="input-style-1">
                            ...
                            <select name="sub_division_document_category_id" id="sub_division_document_category_id" class="form-control">
                                ...
                                @foreach($subDivisionDocumentCategories as $subDivisionDocumentCategory)
                                    <option value="{{$subDivisionDocumentCategory->id}}">{{$subDivisionDocumentCategory->title}}</option>
                                @endforeach
                            </select>
                        ...
                        @if(config('default.dual_language'))
                            <div class="input-style-1">
                                ...
                                <textarea name="description_en" id="description_en" cols="30" rows="10" class="form-control">{{old('description_en')}}</textarea>
