...
<ul class="breadcrumb">
  ...
  <li><a href="#">{{__('Contract Status')}}</a></li>
</ul>
   </div>
     </div>
</div>
...
<div class="container-fluid">
  ...
  <div class="row" style="padding: 5px;">
   <div class="col-md-12">
    ...
    <i class="fa fa-spinner fa-pulse" ></i> {{__('Contract Status')}}<h6 class="content_title">  <span class="pull-right"></span>
      ...
      <table _ngcontent-oit-c76="" id="example" class="table table-bordered table-condensed table-responsive table-hover">
        ...
        <thead _ngcontent-oit-c76="">
          ...
          @if ($dastabej->dastabej_category_id == 5)
