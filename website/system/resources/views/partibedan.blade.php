...
<ul class="breadcrumb">
  ...
  <li><a href="#">{{__('Progress reports')}}</a></li>
</ul>
   </div>
     </div>
</div>
...
<div class="container-fluid">
  ...
  <div class="row" style="padding: 5px;">
   <div class="col-md-12">
    ...
    <i class="fa fa-spinner fa-pulse" ></i> {{__('Progress reports')}}<h6 class="content_title">  <span class="pull-right"></span>
    ...
    <table _ngcontent-oit-c76="" id="example" class="table table-bordered table-condensed table-responsive table-hover">
      ...
      <thead _ngcontent-oit-c76="">
        ...
        <tbody _ngcontent-oit-c76="">
          ...
          @if ($publications->publication_category_id == 6)
