...
<ul class="breadcrumb">
  ...
  <li><a href="#">{{__('Photo gallery')}} </a></li>
</ul>
   </div>
     </div>
</div>
...
<div class="container-fluid">
  ...
  <div class="row" style="padding: 5px;">
   <div class="col-md-12">
    ...
    <i class="fa fa-spinner fa-pulse" ></i> {{__('Photo gallery')}}<h6 class="content_title">  <span class="pull-right"></span>
...
@foreach($photo_album as $photo_album)
    ...
    <a href="{{asset('storage/assets/photo/'.$photo_album->cover_photo)}} " data-lightbox="gallery" >
        <img src="{{asset('storage/assets/photo/'.$photo_album->cover_photo)}}" alt="" style="width: 350px; height:180px;">
      </a>
    <!--<a href="{{route('photo_pic', [\App::getLocale(),$photo_album->id])}}" >
      <img src="{{asset('storage/assets/photo/'.$photo_album->cover_photo)}}" alt="" style="width: 350px; height:180px;">
    </a>-->
