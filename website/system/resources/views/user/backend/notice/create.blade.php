...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>सूचना/ समाचार थप्नुहोस्</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="{{route('notice.index')}}">गृहपृष्ठ</a></li>
            <li class="breadcrumb-item active">सूचना/ समाचार थप्नुहोस्</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
            ...
            <form role="form" Action="{{route('notice.store')}} " method="post" enctype="multipart/form-data" >
              ...
              <div class="card-body">
                <div class="form-group">
                    ...
                    <input type="notice_name" class="form-control" id="notice_name" name="notice_name"  placeholder="Enter Title ">
                    @error('notice_name')
                ...
                @enderror
                  ...
                  <div class="form-group">
                    ...
                    <textarea class="textarea" name="notice_description" id="notice_description" placeholder="Place some text here"
                ...
                @enderror
                  ...
                  <div class="form-group">
                    <label>मिति: *</label>
                    <input type="text" id="nepali-datepicker"    class="form-control @error('notice_date') is-invalid @enderror" name="notice_date" placeholder="Please enter date here." />
                    @error('notice_date')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror
                  ...
                  <div class="form-group">
                    <label>प्रकाशक:</label>
                    <input type="text" name="notice_publisher"  class="form-control">
