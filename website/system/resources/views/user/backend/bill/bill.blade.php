...
<section class="content-header">
    <div class="container-fluid">
      <div class="row mb-2">
        <div class="col-sm-6">
          <h1>बिल सार्बजनिकरण थप्नुहोस्</h1>
        </div>
        <div class="col-sm-6">
          <ol class="breadcrumb float-sm-right">
            <li class="breadcrumb-item"><a href="#">गृहपृष्ठ</a></li>
            <li class="breadcrumb-item active">बिल सार्बजनिकरण थप्नुहोस्</li>
          </ol>
        </div>
      </div>
    </div><!-- /.container-fluid -->
      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <!-- /.card-header -->
            <!-- form start -->
            <form role="form" Action="{{route('bill.store')}} " method="post" enctype="multipart/form-data">
              @include('alert.alert')
              @csrf
              <div class="card-body">
                <div class="form-group">
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="budget_no"  name="budget_no" placeholder="Enter budget number.. ">
                    @error('budget_no')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="expense_head" name="expense_head" placeholder="Enter credit title.. ">
                    @error('expense_head')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                @enderror
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="buying_process" name="buying_process" placeholder="Enter buy method.. ">
              ...
              @enderror
                  ...
                  <div class="form-group">
                    ...
                    <input type="text" id="nepali-datepicker"  value="" name="bill_date"  name="bill_date" class="form-control " placeholder="Please invoice date here." />
                    @error('bill_date')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                @enderror
                  ...
                  <div class="form-group">
                    ...
                    <input type="date" id="post_date"  value="" name="post_date" class="form-control "  />
                    @error('post_date')
                    <span class="invalid-feedback" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
