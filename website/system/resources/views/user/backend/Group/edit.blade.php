      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="card card-primary">
            ...
            <form action="{{route('Group.update',$contactGroup->id)}}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
              <div class="card-body">
                @include('alert.alert')
                <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" name="name" placeholder="Enter Group Name " value="{{$contactGroup->name}}">
                    @error('full_name')
                ...
                @enderror
                  ...
                  <div class="form-group">
                    ...
                    <input type="checkbox" name="contacts[]" id="contact{{$loop->iteration}}" value="{{$contact->id}}"
                        {{ ($contactGroup->Contact->contains($contact->id)) ? 'checked="checked"' : '' }} >
